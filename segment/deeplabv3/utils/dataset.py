...
class SkyDataset(Dataset):
    ...
    def __init__(
        ...
        """
        self.image_filenames = sorted([image for image in os.listdir(image_path)])
        self.image_paths = sorted([image_path + image for image in os.listdir(image_path)])
        self.label_paths = sorted([label_path + label for label in os.listdir(label_path)])
    ...
    def __getitem__(self, index: int):
        ...
        return self.to_tensor(image), label.long(), image_filename
